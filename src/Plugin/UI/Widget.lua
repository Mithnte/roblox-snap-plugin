...
function Widget.new(plugin, stores, onAction)
	...
	local title2 = Instance.new("TextLabel"); title2.Size = UDim2.new(1,0,0,24); title2.Position = UDim2.new(0,0,0,200); title2.BackgroundTransparency = 1; title2.TextXAlignment = Enum.TextXAlignment.Left; title2.Text = "Placement"; title2.Parent = pad
	...
	local title3 = Instance.new("TextLabel"); title3.Size = UDim2.new(1,0,0,24); title3.Position = UDim2.new(0,0,0,280); title3.BackgroundTransparency = 1; title3.TextXAlignment = Enum.TextXAlignment.Left; title3.Text = "Quick Actions"; title3.Parent = pad
	local anchorRow = Instance.new("TextButton"); anchorRow.Size = UDim2.new(1, -16, 0, 26); anchorRow.Position = UDim2.new(0,0,0,308); anchorRow.Text = "Toggle Anchor (Selection)"; anchorRow.Parent = pad
